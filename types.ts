 ...
 *
 * @property i Si la partida se encuentra en un interludio entre rondas (interlude)
 * @property s Si el equipo tiene sólamente un miembro (solo)
 * @property rt El tiempo restante actual para la siguiente fase (round time)
 * @property tt El tiempo restante actual para el siguiente turno (turn time)
 * 
 */
...
export declare type SoundName = "notification" | "correctWord";
